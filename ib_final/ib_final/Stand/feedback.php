                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="adminprofile.php"><i class="material-icons">person</i>Profile</a></li>
                        ...
                        <div class="body">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    ...
                                    <?php
                                    $sel_col=mysql_query("select * from feedback  where station='$r_data[3]'");
                                    echo mysql_error();
                                    if(mysql_num_rows($sel_col)>0)
                                    {
                                        ...
                                        while($r_col=mysql_fetch_row($sel_col))
                                        {
                                            ...
                                            $state=$r_col[4];
                                            $feed=$r_col[5];
                                            $sel_bus=mysql_query("select DistrictName from district where DistCode='$dist'");

                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <?php
                            $sel_stf=mysql_query("select * from staff_data where stat_id='$r_data[0]'");
                            ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            {
                                $bid=$r_bus[0];
                                $sel_col=mysql_query("select sum(amt) from daily_trip where bus_id='$bid' and date='$dt'");
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <?php
                            $sel_u=mysql_query("select * from user_data where st_id='$sid'");
                            ?>
                            <div class="number count-to" data-from="0" data-to="<?php echo mysql_num_rows($sel_u) ?>" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                        ...
                                        <?php
                                        $i=0;
                                        $sel_b1=mysql_query("select * from bus_assign where station_id='$r_data[0]'");
                                        while($r_b1=mysql_fetch_row($sel_b1))
                                        {
                                            $sel_bdata=mysql_query("select * from bus_data where bus_id='$r_b1[0]'");
                                            $r_bdata=  mysql_fetch_row($sel_bdata);
                                            $i++;
                                            ?>
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $r_bdata[1] ?></td>
                                            <td><?php echo $r_bdata[2] ?></td>
                                            <td><?php echo $r_bdata[3] ?></td>
                                            <td>
                                            <?php
                                            $sel_dr=mysql_query("select * from staff_assign,staff_data where staff_data.uid=staff_assign.stf_id and staff_assign.bus_id='$r_b1[0]' and staff_assign.typ=1");
                                            if(mysql_num_rows($sel_dr)>0)
                                            {
                                            $r_dr=mysql_fetch_row($sel_dr);
                                            echo "<SPAN class='glyphicon glyphicon-user'></SPAN> $r_dr[6]<br /><SPAN class='glyphicon glyphicon-phone-alt'></SPAN> $r_dr[8]";
                                            }
                                            else{
                                                echo "<font color='red'>Not Assigned</font>";
                                            }
                                            ?>
                                            </td>
                                            <td>
                                            <?php
                                            $sel_con=mysql_query("select * from staff_assign,staff_data where staff_data.uid=staff_assign.stf_id and staff_assign.bus_id='$r_b1[0]' and staff_assign.typ=2");
                                            if(mysql_num_rows($sel_con)>0)
                                            {
                                            $r_con=mysql_fetch_row($sel_con);
                                            echo "<SPAN class='glyphicon glyphicon-user'></SPAN> $r_con[6] <br /><SPAN class='glyphicon glyphicon-phone-alt'></SPAN> $r_con[8]";
                                            }
                                            else{
                                                echo "<font color='red'>Not Assigned</font>";
                                            }

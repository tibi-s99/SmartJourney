                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <form method="post" enctype="multipart/form-data">
                                                                             ...
                                                                             <?php
                                                                             $st=$_GET['st'];
                                                                             $sel=mysql_query("select * from station_data where st_code='$st'");
                                                                            
                                                                             $result=mysql_fetch_row($sel);
                                                                             ...
                                                                             ?>
                                                                              ...
                                                                              <table class="table" border="2" style="width: 100%" >
                                                                                  ...
                                                                                  <tr>  <td>
                                                                                          station name</td><td> <?php  echo $result[3];?></tr>
                                                                                      <tr>  <td>
                                                                                       station code</td><td><?php  echo $result[5];?></tr>
                                                                                              <tr>  <td>
                                                                                          station master</td><td><?php  echo $result[6];?></tr>
                  
 <tr>  <td>
                                                                                          user id</td><td><?php  echo $result[7];?></tr>
                  
 <tr>  <td>
                                                                                          Address</td><td><?php  echo $result[8];?></tr>
  <tr>  <td>
                                                                                          contact</td><td><?php  echo $result[9];?></tr>
   <tr>  <td>
                                                                                          mail</td><td><?php  echo $result[10];?></tr>
                                                                              </table>
               </td>
           <tr>
                                ...
                                <div class="col-lg-6">
                                    <img src="station_pic/<?php  echo $result[11];?>" class="img img-responsive" /> 
                                    <b>
                                        ASSIGNED BUSES
                                    </b>
                                    <?php
                                    ...
                                    if(mysql_num_rows($se)>0)
                                    {
                                        ...
                                        {
                                            $rl=$r[0];
                                            $sel=mysql_query("select * from bus_data where bus_id='$rl'");
                                            if(mysql_num_rows($sel)>0)
                                            {
                                                
                                                while($re=mysql_fetch_row($sel))
                                            {?>
                                    <table border="2"> <tr><td> bus id

                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <?php
                                    $i=0;
                                    $sel_bus=mysql_query("select * from bus_data order by bus_id desc");
                                    while($r_bus=mysql_fetch_row($sel_bus))
                                    {
                                        $counr_trp=mysql_query("select * from trip_data where bus_id='$r_bus[0]'");
                                        $count=mysql_num_rows($counr_trp);
                                        $i++;
                                        ?>
                                        <tr>
                                            <td rowspan="<?php echo $count+1 ?>"><?php echo $i ?></td>
                                            <td rowspan="<?php echo $count+1 ?>"><?php echo$r_bus[1] ?></td>
                                            <td rowspan="<?php echo $count+1 ?>"><?php echo$r_bus[2] ?></td>
                                            <td rowspan="<?php echo $count+1 ?>"><?php echo$r_bus[3] ?></td>
                                        </tr>
                                       
                                                <?php
                                                $sel_trp=mysql_query("select * from trip_data where bus_id='$r_bus[0]'");
                                                while($r_trp=mysql_fetch_row($sel_trp))
                                                {
                                                    ?>
                                                 <tr>
                                                ...
                                                ?>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $sel_amt=mysql_query("select amt from daily_trip where trip_id='$r_trp[0]' and date='$dt'");

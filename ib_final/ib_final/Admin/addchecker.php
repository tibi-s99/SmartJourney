...
if(isset($_POST['add_stf']))
{
	...
	{
    $ins_user=mysql_query("insert into staff_data values('','$nme','$addr','$con','$dt','$styp','$stid','".$fn."','no','1')");
    if($styp==3)
    {
        $ins_log=mysql_query("insert into user_login values('','$stid','ksrtc','checker','1')");
    }
    if($ins_user>0)
    {
        if(move_uploaded_file($_FILES['up']['tmp_name'], getcwd()."\\staff\\$fn"))  
        {
            header("location:addchecker.php?success=1");
        }
    }
}
}
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="con" required="" class="form-control"maxlength="10"onblur="chkcon(this.value)"required="required" />
                                                    <span id="o3"></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>Staff ID</td>
                                                <td><input type="text"required="" name="stid" class="form-control" /></td>
                                            </tr>
                                            <tr>
                                                <td>Photo</td>
                                            ...
                                            <tr>
                                                <td colspan="2"><center><input type="submit" name="add_stf" value="ADD CHECKER" class="bt btn-danger" /></center></td>
                                            </tr>  
                                        </table>
                                        </form>

...
if(isset($_POST['iss_tkt']))
{
    ...
    if($ins_tkt>0)
    {
        ...
        header("location:trip.php?num=$item");
    }
    }
    }
 else {
...
if(isset($_POST['b4']))
{
    ...
    $chk_login=mysql_query("select * from staff_data where st_id='$t1'");
    if(mysql_num_rows($chk_login)>0)
    {
        
      header("location:chk.php?st=$t1");   
        
    }
 else {
       header("location:chk.php?fail=1");    
    }
}
?>
﻿<!DOCTYPE html>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                ...
                                <center>
                                    <h3>Check Staff Information</h3></center>
                                <div class="col-lg-6">
                                    ...
                                    <form method="post">
                                         <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                             ...
                                             <tr>
                                                 <td>staff</td>
                                                 <td><input type="text" name="t1" required="required" class="form-control" /></td>
                                             </tr>
                                             
                                             <tr>
                                                 <td colspan="2"><center><input type="submit" name="b4" value="ISSUE TICKET" class="btn btn-sm btn-danger" /> </center>
                                         <?php
                                         if(isset($_GET['fail']))
                                         {
                                         ...
                                         ?>
                                             <center>
                                                 <span style="color: red">Invalid Staff ID</span></center>
                                             <?php
                                         }
                                         ?>
                                ...
                                {
                                  $st=$_GET['st'];  
                                $se=  mysql_query("select * from staff_data where st_id='$st'");
                                $sr=  mysql_fetch_row($se);
                                ...
                                <div class="col-lg-6">
                                         ...
                                         <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                             ...
                                             <tr>
                                                 ...
                                                 <td colspan="2"><img style="width: 100%;height: 300px" src="../Stand/staff/<?php echo $sr[7] ?>"</td>
                                             </tr>
                                             <tr>
                                                 <td>Name:</td>
                                                 <td><?php echo $sr[1] ?></td>
                                             ...
                                             <tr>
                                                 <td colspan="2"><center><input type="submit" name="iss_tkt" value="Check" class="btn btn-sm btn-danger" /> </center></td>
                                             </tr>
                                         </table>

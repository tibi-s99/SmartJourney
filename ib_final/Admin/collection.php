                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <a style="text-decoration: none" href="colmanage.php"<h2>COLLECTION Graph <span style="color: #0000ff" class="glyphicon glyphicon-hourglass"></span></h2></a>
                                </div>                                
                            </div>                            
                        </div>
                        <div class="body">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    ...
                                    <?php
                                    $sel_col=mysql_query("select * from daily_trip where date='$dt' order by amt desc limit 10");
                                    if(mysql_num_rows($sel_col)>0)
                                    {
                                        $i=0;
                                        while($r_col=mysql_fetch_row($sel_col))
                                        {
                                            $bid=$r_col[2];
                                            $tid=$r_col[4];
                                            $sel_bus=mysql_query("select * from bus_data where bus_id='$bid'");
                                            $r_bus=mysql_fetch_row($sel_bus);
                                            $sel_trip=mysql_query("select * from trip_data where trip_id='$tid'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $r_trip[3] ?></td>
                                            <td>Rs. <?php echo $r_col[6] ?>/-</td>
                                        </tr>
                                        <?php
                                        }
                                    }
                                ...
                                <table class="table table-bordered table-condensed table-responsive">
                                    ...
                                    <?php
                                    $sel_col=mysql_query("select * from daily_trip where date='$dt' order by amt ASC limit 10");
                                    if(mysql_num_rows($sel_col)>0)
                                    {
                                        $i=0;
                                        while($r_col=mysql_fetch_row($sel_col))

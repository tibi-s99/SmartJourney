...
$x=$_GET['q'];
$sel_st=mysql_query("select * from station_data where state='$x'");
...
<table class="table table-bordered table-condensed table-hover table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            {
                ?>
            <a href="stationdetails.php?st=<?php echo $r_st[5] ?>"><span class="glyphicon glyphicon-eye-open" style="color:blue;"></span></a>
            <?php
            }
            else
            {
